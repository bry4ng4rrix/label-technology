...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE_URL}/services/comptabilite`,   lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE_URL}/projets`,                 lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE_URL}/about`,                   lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE_URL}/recru`,                   lastModified: now, changeFrequency: "weekly",  priority: 0.6 },
