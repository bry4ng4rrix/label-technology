...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Call center 50 postes FR/EN, développement web & mobile, marketing digital, ERP, traitement de données. Depuis Antananarivo, pour la France et l'Afrique.",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Label Technology" }],
  },
  twitter: {
...
const jsonLd = {
  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      { "@type": "Offer", itemOffered: { "@type": "Service", name: "Développement Web & Mobile", url: "https://labeltechnology.mg/services/dev" } },
      { "@type": "Offer", itemOffered: { "@type": "Service", name: "Call Center 50 Postes FR/EN", url: "https://labeltechnology.mg/services/callcenter" } },
      { "@type": "Offer", itemOffered: { "@type": "Service", name: "Marketing Digital", url: "https://labeltechnology.mg/services/marketing" } },
      { "@type": "Offer", itemOffered: { "@type": "Service", name: "Digitalisation & ERP", url: "https://labeltechnology.mg/services/digital" } },
      { "@type": "Offer", itemOffered: { "@type": "Service", name: "Traitement de Données", url: "https://labeltechnology.mg/services/data" } },
      { "@type": "Offer", itemOffered: { "@type": "Service", name: "Matériel Informatique", url: "https://labeltechnology.mg/services/materiel" } },
      { "@type": "Offer", itemOffered: { "@type": "Service", name: "Comptabilité & Reporting", url: "https://labeltechnology.mg/services/comptabilite" } },
    ],
  },
};
