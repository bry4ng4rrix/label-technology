        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p
              ...
              style={{ color: "var(--mid)" }}
            >
              Madagascar n'est pas un choix par défaut. C'est un choix
              stratégique. Les entreprises qui externalisent leur call center à
              Antananarivo bénéficient d'une combinaison unique : qualité
              européenne, réactivité africaine, coût compétitif.
            </p>
            <div
              className="flex items-center gap-3 p-4 rounded-sm border"
              style={{
                borderColor: "var(--brand)",
                backgroundColor: "rgba(30,63,171,0.04)",
              }}
            >
              <span className="text-2xl">🌍</span>
              <p className="text-sm font-light" style={{ color: "var(--ink)" }}>
                <strong>Antananarivo</strong>, capitale de Madagascar — hub
                technologique de l'océan Indien, 3,5M d'habitants, 2 universités
                techniques.
              </p>
            </div>
          </div>
