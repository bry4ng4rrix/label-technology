        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filtered.map((o, i) => {
            ...
            return (
              <article
                key={`${active}-${i}`}
                className="job-card group flex flex-col bg-white rounded-xl overflow-hidden border border-black/6 hover:border-transparent hover:shadow-2xl hover:-translate-y-1.5 transition-all duration-300"
              >
