...
const PHOTOS = [
  {
    ...
    h: "h-[170px] sm:h-[200px] md:h-[230px] lg:h-[260px]",
  },
  {
    id: "callcenter",
    ...
    h: "h-[200px] sm:h-[230px] md:h-[260px] lg:h-[290px]",
  },
  {
    id: "marketing",
    ...
    h: "h-[225px] sm:h-[255px] md:h-[285px] lg:h-[315px]",
  },
  {
    id: "digital",
    ...
    h: "h-[245px] sm:h-[275px] md:h-[305px] lg:h-[335px]",
  },
  {
    id: "data",
    href: "/services/data",
...
const Hero = () => {
  return (
    <section className="relative w-full overflow-hidden bg-slate-950 px-4 sm:px-6 pt-28 pb-16 md:pt-36 md:pb-20">
      ...
      {/* Texte central */}
      <div className="relative z-10 max-w-3xl mx-auto text-center mb-2 md:mb-16">
      ...
      {/* Arc de photos */}
      <div className="animate-fadeup-d5 relative z-10 max-w-6xl mx-auto flex items-end justify-center gap-2 sm:gap-3 md:gap-4 mb-14 md:mb-20">
        {PHOTOS.map((p) => (
          <Link
            key={p.id}
            href={p.href}
          ...
          >
            <Image
              ...
              alt={p.alt}
              fill
              sizes="(max-width: 768px) 13vw, 140px"
