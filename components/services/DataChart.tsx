...
export default function DataChart() {
  return (
    <div className="glass-dark rounded-3xl p-6">
      <p className="label-tag mb-1 text-brand-glow">RÉPARTITION DES MISSIONS</p>
      ...
      <div className="grid grid-cols-4 gap-px mt-4" style={{ backgroundColor: "rgba(255,255,255,0.06)" }}>
        {KPIS.map((k, i) => (
          <div key={i} className="text-center py-3 px-1" style={{ backgroundColor: "rgba(0,0,0,0.35)" }}>
            <div className="font-display text-lg text-brand-glow">{k.v}</div>
